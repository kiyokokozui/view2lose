...
struct FrontFacingCameraView1: View {
    ...
    var body: some View {
            VStack {
                ...
                if cameraViewModel.changeToFrontCamera {
                    CustomFrontFacingCameraView(viewModel: cameraViewModel, image: self.$inputImage, currentCamera: self.$currentCamera, overlayView : UIView(), sideImage: false)
                } else {
                    CustomFrontFacingCameraView(viewModel: cameraViewModel, image: self.$inputImage, currentCamera: self.$currentCamera, overlayView: UIView(), sideImage: false)
                }
...
struct CustomFrontFacingCameraView1: View {
...
class CustomCameraController: UIViewController {
    ...
    func setupDevice() {
        let deviceDiscoverySession = AVCaptureDevice.DiscoverySession(deviceTypes: [AVCaptureDevice.DeviceType.builtInDualCamera],
...
struct FrontFacingCameraView1_Previews: PreviewProvider {
